...
<html>
  ...
  <body>
   		<center>
   			<h1>入库</h1>
   			<h3><a href="${pageContext.request.contextPath }/showAdmin.do">返回主页</a></h3>
   			<form action="${pageContext.request.contextPath }/inputProducts.do" method="post" onsubmit="return checkForm()">
