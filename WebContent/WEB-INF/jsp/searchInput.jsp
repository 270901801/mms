...
<html>
  <head>
    ...
    <script type="text/javascript">
        ...
        function groupByPro()
        {
        	...
        	document.forms[0].action="groupByInputResult.do";
  ...
  <body>
   		...
   		<h3><a href="${pageContext.request.contextPath }/selectAll.do">返回主页</a></h3>
   			<form action="${pageContext.request.contextPath }/searchInputByKeyword.do" method="post" onsubmit="return checkForm()">
   			<table width="900" cellspacing="0" border="1">
   				<tr>
   				<td colspan="7">
	   				产品名称：<input id="name" name="name" size="10"/>
	   				起始日期：<input name="startDate" id="startTime" onclick='popUpCalendar(this,this,"yyyy-mm-dd")' readonly
	   				size="8"/>
	   				&nbsp;&nbsp;&nbsp;
	   				结束日期：<input name="enDate" id="endTime" onclick='popUpCalendar(this,this,"yyyy-mm-dd")' readonly
	   				size="8"/>
	   				&nbsp;&nbsp;&nbsp;
